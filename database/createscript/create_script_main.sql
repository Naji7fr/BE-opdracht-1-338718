-- Step: 01
-- Goal: Create a new database magazijn
-- **********************************************************************************
-- Version       Date:           Author:                     Description:
-- *******       **********      ****************            ******************
-- 01            29-10-2025      Naji                        New Database
-- **********************************************************************************/

-- Create database if it doesn't exist
CREATE DATABASE IF NOT EXISTS `magazijn` 
CHARACTER SET utf8mb4 
COLLATE utf8mb4_unicode_ci;

-- Use database magazijn
USE `magazijn`;
...
-- Version:       Date:       Author:           Description
-- ********       ****        *******           ***********
-- 01             29-10-2025  Naji              New table
-- 02             29-10-2025  Naji              Default aangepast
-- **************************************************************
...
-- Version:       Date:       Author:           Description
-- ********       ****        *******           ***********
-- 01             29-10-2025  Naji              Insert Records
-- ***********************************************************
...
-- Step 14:
-- Goal: Create stored procedure sp_GetAllProducts
-- ********************************************************
DELIMITER $$
